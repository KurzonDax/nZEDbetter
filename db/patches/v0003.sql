...
ALTER TABLE `predb`
    ...
    ADD INDEX  `ix_releaseGroup_title` (  `releaseGroup` ,  `title` ( 2 ) ) COMMENT  '';
...
ALTER TABLE  `releases` ADD  `tmdbID` INT NULL DEFAULT NULL AFTER  `imdbID` ,
	...
	ADD  `preDbId` INT(11) NULL DEFAULT NULL AFTER `anidbID`,
...
INSERT INTO `site` (`ID`, `setting`, `value`, `updateddate`) VALUES (NULL, 'forceWebDlInApiResults', '1', CURRENT_TIMESTAMP);
