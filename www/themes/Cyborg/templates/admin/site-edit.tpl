...
{/if}
<div class="tabber" id="siteedittabs">

<div class="tabbertab">
    <h2><a name="Main">Main Settings</a></h2>
    <fieldset>
        <legend> Main Site Settings, Html Layout, Tags</legend>

        <table class="input" id="MainSettings">
            ...
            <tr>
                ...
                <td>
                    ...
                    if you are getting errors such as DECODING_FAILED when you attempt to access your site, then disable this option.</div>
                </td>
            </tr>
    ...
    <fieldset>
        ...
        <table class="input">
            ...
            <tr>
                <td><label for="groupMaxMsgsPerLoop">Max articles to retrieve<br/>per update loop:</label></td>
                <td>
                    <input class="medium" id="groupMaxMsgsPerLoop" name="groupMaxMsgsPerLoop" type="text" value="{$fsite->groupMaxMsgsPerLoop}" /> Posts<br />
                    <div class="hint">This is the maximum number of article headers that will be downloaded per group each time the update binaries script runs.  This
                     is helpful to prevent highly prolific groups from blocking the updating of other groups.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="switchToPosts">Automatically switch to fill by posts:</label></td>
                <td>
                    {html_radios id="switchToPosts" name='switchToPosts' values=$yesno_ids output=$yesno_names selected=$site->switchToPosts separator='<br />'}
                    <div class="hint">This setting is only applicable if you have 'Days' selected above for starting new groups.  By setting this to yes, if a group
                     has no psots within the number of days set above, the script will instead try to update the group based on the number of posts entered above. This
                    is useful for groups that don't update very often.</div>
                </td>
            </tr>
            <tr>
...
<div class="tabbertab">
    <h2><a name="Advertisements">Ad Settings</a></h2>
    <fieldset>
...
<div class="tabbertab">
    <h2><a name="APIkeys">API Keys</a></h2>
    <fieldset>
        ...
        <table class="input">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="hint">Whether to attempt to process a video sample, these videos are very short 1-3 seconds, 100KB on average, in .ogg format. ffmpeg must be installed for this.<br/></div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="hint">Whether to attempt to retrieve the an nfo file from usenet when processing binaries.</div>
                </td>
            </tr>
...
<div class="tabbertab">
    <h2><a name="Threads">Release Lookups</a></h2>
    <fieldset>
        <legend>TV Episode Processing</legend>
        <table class="input">
            <tr>
        ...
        <legend>Movie Processing</legend>
        <div class="alert-success" style="margin: 20px; padding: 10px;">Please note that if you are planning to use The MovieDB (TMDB) for movie binary identification, you will need to
            obtain an api key from TMDB.  The api key is free of charge. <br />
            More information can be found at the <a href="http://www.themoviedb.org/documentation/api" target="_blank" style="color: darkred">TMDB</a> website. </div>
        ...
        <table class="input">
            ...
            <tr>
                <td><label for="matchMoviesWithoutYear">Match movies with no year:</label></td>
                <td>
                    {html_radios id="matchMoviesWithoutYear" name='matchMoviesWithoutYear' values=$trueFalse output=$trueFalse selected=$fsite->matchMoviesWithoutYear separator='<br />'}
                    <div class="hint">Whether to try and match movies that do not have a year in the release name.  Setting this to TRUE will tend to result in a higher number of releases
                     associated with the wrong movie.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="processForeignMovies">Process Foreign Movies:</label></td>
                <td>
                    {html_radios id="processForeignMovies" name='processForeignMovies' values=$trueFalse output=$trueFalse selected=$fsite->processForeignMovies separator='<br />'}
                    <div class="hint">Setting this to false will prevent movies assigned to the Foreign category from being sent through the lookup process.</div>
                </td>
            </tr>
            <tr>
        ...
        <legend>Music, Games, and Book Processing</legend>
        <div class="alert-success" style="margin: 20px; padding: 10px;">Please note that if you are planning to use Amazon to look up music, game, and book releases, you must have a valid Amazon affiliate account.
            This is not the same as a standard personal Amazon account used for shopping.<br />
            More information can be found at the <a href="https://affiliate-program.amazon.com/" target="_blank" style="color: darkred">Amazon Affiliate Program</a> website. </div>
        <table class="input">
            <tr>
                <td><label for="lookupmusic">Lookup music using Amazon:</label></td>
                <td>
            ...
            <tr>
                <td><label for="musicBrainzServer">URL for MusicBrainz Server:</label></td>
                <td>
                    <input class="large" id="musicBrainzServer" name="musicBrainzServer" type="text" value="{$fsite->musicBrainzServer}" />
                    <div class="hint">If you wish to use a MusicBrainz server for music identification, enter the full URL here.  Be sure to include a port number, if applicable.</div>
                    <div class="alert-success" style="margin: 20px; padding: 10px;">
                        NOTE: MusicBrainz significantly enhances the chances of accurately identifying music binaries. However, if
                        you want to use the MusicBrainz service, it is <strong>strongly</strong> recommended that you build and configure your own MusicBrainz
                        replica server.  Full instructions can be found here: <a href="http://nzedbetter.org/index.php?title=MusicBrainz" target="_blank" style="color: darkred">MusicBrainz replica configuration.</a></div>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="lookupgames">Lookup Games using Amazon:</label></td>
                <td>
            ...
            <tr>
                <td><label for="lookupbooks">Lookup Books using Amazon:</label></td>
                <td>
            ...
            <tr>
                <td><label for="getAmazonRating">Get average customer ratings:</label></td>
                <td>
                    {html_radios id="getAmazonRating" name='getAmazonRating' values=$trueFalse output=$trueFalse selected=$fsite->getAmazonRating separator='<br />'}
                    <div class="hint">Setting this to true will cause the Amazon lookup script to retrieve the average customer rating for music, games, and books.  Note that
                    this will slow down processing of these releases slightly as it requires an additional http request to Amazon for each release.</div>
                </td>
            </tr>
            <tr>
        ...
        <legend>Request ID Settings</legend>
        <table class="input">
            <tr>
...
{*<input type="submit" class="btn btn-primary btn-large" value="Save Site Settings"><i class="icon-save"></i> Save Tmux Settings</input>*}
<button id="SaveSettings" type="submit" class="btn btn-primary btn-default" style="float: right; margin-top: 15px"><i class="icon-save"></i> Save Site Settings</button>
</form>
