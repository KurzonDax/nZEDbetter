        ...
        <table class="table table-collapsed table-striped table-bordered table-hover data highlight icons" id="browsetable">
            ...
            {foreach from=$results item=result}
                <tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}" id="guid{$result.guid}">
                    ...
                    <td class="item" style="width:65%;text-align:left;">
                        ...
                        {if $result.passwordstatus == 1}
                            <img title="Probably Passworded" src="{$smarty.const.WWW_TOP}/themes/{$site->style}/images/icons/lock2.png" alt="Probably Passworded">
                        {elseif $result.passwordstatus == 2}
                            <img title="Broken post" src="{$smarty.const.WWW_TOP}/themes/{$site->style}/images/icons/broken.png" alt="Broken post">
                        {elseif $result.passwordstatus == 10}
                            <img title="Passworded archive" src="{$smarty.const.WWW_TOP}/themes/{$site->style}/images/icons/lock.gif" alt="Passworded archive">
                        {/if}
                    ...
                    <td class="files" style="width:auto;text-align:center;white-space:nowrap;">
                        ...
                        {if $result.rarinnerfilecount > 0}
                            <div class="rarfilelist">
                                <img src="{$smarty.const.WWW_TOP}/themes/{$site->style}/images/icons/magnifier.png" alt="{$result.guid}" class="tooltip">
                            </div>
                        {/if}
                    </td>
