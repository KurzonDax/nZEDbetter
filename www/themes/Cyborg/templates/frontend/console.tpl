            ...
            {foreach from=$results item=result}
                <tr>
                        ...
                        <div class="movcover" style="padding-bottom:5px;">
                            ...
                            <div class="relextra" style="margin-top: 10px">
                                <center>
                                    ...
                                    {if $result.url != ""}<a class="label label-primary" target="_blank" href="{$site->dereferrer_link}{$result.url}" name="amazon{$result.consoleinfoID}" title="View amazon page">Amazon</a>{/if}
                    ...
                    <td colspan="8" class="left" id="guid{$result.guid}">
                        ...
                        <div class="container">
                            <a class="label label-primary" href="{$smarty.const.WWW_TOP}/console?platform={$result.platform}" title="View similar nzbs">Similar</a>
                            {if $isadmin || $ismod}
