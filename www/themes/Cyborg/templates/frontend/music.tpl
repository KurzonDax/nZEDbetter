                ...
                <td style="width:150px;padding:10px;">
                    ...
                    <div class="relextra">
                        <center>
                            ...
                            {if $result.url != ""}<a class="label label-primary" target="_blank" href="{$site->dereferrer_link}{$result.url}" name="amazon{$result.musicinfoID}" title="View amazon page">Amazon</a>{/if}
...
{else}
    <div class="alert">
        ...
        <strong>Sorry!</strong> We apologize, but there does not appear to be any NZB's in this category.
    </div>
{/if}
