...
{assign var="icon" value='templates/{$site->style}/images/fileicons/'|cat:$file.ext|cat:".png"}
...
<td><img title=".{$file.ext}" alt="{$file.ext}" src="{$smarty.const.WWW_TOP}/themes/{$site->style}/images/fileicons/{$icon}.png"></td>
