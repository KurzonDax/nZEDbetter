...
<div class="container">
    <div class="row" style="margin-top: 10px">
        <div  class="pull-left" style="width: 20%" > {* class="col-4" text-align:center *}
            ...
            {if $con && $con.cover == 1}<img class="shadow img-thumbnail" style="vertical-align:top; box-shadow: 8px 8px 5px #555;" src="{$smarty.const.WWW_TOP}/covers/console/{$con.ID}.jpg" alt="{$rage.releasetitle|escape:"htmlall"}">{/if}
            {*{$smarty.const.WWW_TOP}/covers/console/{$con.ID}.jpg" width="160" alt="{$con.title|escape:"htmlall"}*}

            {if $music && $music.cover == 1}<img class="shadow img-thumbnail" style="vertical-align:top; box-shadow: 8px 8px 5px #555;" src="{$smarty.const.WWW_TOP}/covers/music/{$music.ID}.jpg" alt="{$rage.releasetitle|escape:"htmlall"}">{/if}
            {*{$smarty.const.WW>{/if}W_TOP}/covers/music/{$music.ID}.jpg" width="160" alt="{$music.title|escape:"htmlall"}*}

            {if $book && $book.cover == 1}<img class="shadow img-thumbnail" style="vertical-align:top; box-shadow: 8px 8px 5px #555;" src="{$smarty.const.WWW_TOP}/covers/book/{$book.ID}.jpg" alt="{$rage.releasetitle|escape:"htmlall"}">{/if}
            {*{$smarty.const.WWW_TOP}/covers/book/{$book.ID}.jpg" width="160" alt="{$book.title|escape:"htmlall"}*}

        </div>
        <div  class="pull-right" style="width: 80%;margin-top: 3px;"> {* class="col-8" *}
