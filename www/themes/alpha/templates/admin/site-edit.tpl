<script language="javascript" type="text/javascript">
    function showHide(shID) {
        if (document.getElementById(shID)) {
            if (document.getElementById(shID).style.visibility = 'collapse') {
                document.getElementById(shID).style.visibility = 'visible';
            }
            else {
                document.getElementById(shID).style.visibility = 'collapse';
            }
        }
    }
</script>
...
<fieldset>
<legend> Main Site Settings, Html Layout, Tags <a href="#" id="MainSettings-show" class="showLink" onclick="showHide('MainSettings');return false;">Show</a> </legend>

<table class="optionarea" id="MainSettings">
...
<tr>
    <td><a href="#" id="MainSettings-hide" class="hideLink" onclick="showHide('MainSettings');return false;">Hide this section.</a></td>
</tr>
</table>
...
<tr>
    <td><label for="switchToPosts">Change to backfill by posts for a group if no posts are found within days set above:</label></td>
    <td>
