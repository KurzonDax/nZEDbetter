<div id="menucontainer"> 
	<div id="menusearchlink">
		<form id="headsearch_form" action="{$smarty.const.WWW_TOP}/search/" method="get">
			...
			<div class="clearbutton" title="Clear form"><input id="headsearch_clear" type="reset" value="Clear" tabindex="4" /></div>
			...
			<input id="headsearch" name="search" value="{if $header_menu_search == ""}Enter keywords{else}{$header_menu_search|escape:"htmlall"}{/if}" style="width:80%;" type="text" tabindex="1" /> 
